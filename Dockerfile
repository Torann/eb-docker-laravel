...
RUN apt-get clean && apt-get update && apt-get install -y zlib1g-dev libicu-dev libpq-dev libfreetype6 wget gdebi xfonts-base xfonts-75dpi fonts-wqy-microhei ttf-wqy-microhei fonts-wqy-zenhei ttf-wqy-zenhei libpng urw-fonts libXext openssl-devel libXrender xorg-x11-fonts-cyrillic.noarch cjkuni-fonts-ghostscript.noarch cjkuni-ukai-fonts.noarch cjkuni-uming-fonts.noarch vlgothic-fonts.noarch texlive-uhc.noarch libmagickwand-dev libmagickcore-dev imagemagick \
